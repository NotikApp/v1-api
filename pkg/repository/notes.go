...
func (r *NotesRepo) CreateNote(userId int, input gonotes.Note) (int, error) {
	var created int
	query := fmt.Sprintf("INSERT INTO %s (title, text, important, tags, user_id) VALUES ($1, $2, $3, $4, $5) RETURNING id", notes)
